...
alert('AKTUALIZACJA MOBYWATEL BY MLODY G - MPRAWO JAZDY JUZ DZIALA!');
var passwordLogin = document.querySelector(".login");
...
var input = document.querySelector(".password_box .password_input");
